...
public class AllureConstants {
    ...
    public static final Path RESULTS_FOLDER = Paths.get(String.valueOf(USER_DIR),"Test-out", "allure-results",File.separator);
    public static final Path REPORT_PATH = Paths.get(String.valueOf(USER_DIR),"Test-out", "reports",File.separator); //single report .html
    public static final Path FULL_REPORT_PATH = Paths.get(String.valueOf(USER_DIR),"Test-out", "full-report",File.separator);
